...
router.post('/inscri', async (req,res)=>{
   ...
   let  {password,nom,prenom,tel,sexe,ville,cin,adresse,notification,message,mydoctor,photo}=req.body;
   try {
       let user;

            user = new User({password,nom,prenom,tel,sexe,ville,cin,adresse,notification,message,mydoctor,photo});
       await user.save();
